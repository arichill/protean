...
class CmdDescribify(Command):
    ...
    def func(self):
        if not self.args:
            self.caller.msg("What would you like to change to the description of?")
            return
...
class TakeAPicture(Command):
    """
    Command to capture a particular object description
    """
    ...
    def func(self):
        ...
        create_object(key="polaroid picture",
                      location=self.caller,
                      aliases="polaroid",
                      attributes=[("desc", f"A picture of {target.key}.\n{desc}")])


class SpawnItems(Command):
    """
    Command to trigger item spawning from list generated by LLM
    """
    key = "spawn"
